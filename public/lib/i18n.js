...
const translations = {
  es: {
    ...
    'auth.step1Email': 'Inicia sesión con tu correo y contraseña.',
    'auth.step2Confirm': 'Solicita un pase para comenzar.',
    'auth.step3Login': 'Recibirás una confirmación por WhatsApp cuando tu pase sea aprobado, y entonces podrás reservar clases.',
    ...
    'admin.generateSub': 'Ajustes manuales del horario',
    ...
    'admin.generateAutoInfo': 'Las clases se generan automáticamente cada día a las 7am. Usa los botones de abajo solo si quieres aplicar los cambios ahora mismo, sin esperar al siguiente ciclo.',
    'admin.generatePreviewTitle': 'Ver qué pasaría',
    'admin.generatePreviewDesc': 'Muestra cuántas clases se crearían, cancelarían o restaurarían con los ajustes actuales. No hace ningún cambio real.',
    'admin.generateNextTitle': 'Generar clases ahora',
    'admin.generateNextDesc': 'Crea las clases que faltan para las próximas 2 semanas según las plantillas activas. Las clases ya creadas no se modifican.',
    'admin.resyncTitle': 'Actualizar clases ya creadas',
    'admin.resyncDesc': 'Si cambiaste el horario, tipo o capacidad de una plantilla, este botón actualiza las clases futuras ya creadas para que reflejen el cambio.',
    ...
    'notifications.loadError': 'Error al cargar el historial.',
    'notifications.allChannels': 'Todos los canales',
    'notifications.allEvents': 'Todos los eventos',
    'notifications.noResults': 'Sin resultados',
    'notifications.countRange': '{from}–{to} de {total}',
    'notifications.noRecords': 'Sin registros',
    'notifications.prev': '← Anterior',
    'notifications.next': 'Siguiente →',
    'notifications.message': 'Mensaje',
    'notifications.fullError': 'Error completo',
    'notifications.exactDate': 'Fecha exacta',
    'notifications.details': 'Detalles',
    'notifications.timeNow': 'ahora',
    'notifications.timeMinutes': 'hace {n} min',
    'notifications.timeHours': 'hace {n} h',
    'notifications.timeYesterday': 'ayer',
    'notifications.timeDays': 'hace {n} d',
    'notifications.event.pass_request': 'Solicitud de pase',
    'notifications.event.pass_approved': 'Pase aprobado',
    'notifications.event.pass_declined': 'Pase rechazado',
    'notifications.event.expiry_reminder': 'Aviso vencimiento',
    'notifications.event.low_classes': 'Pocas clases',
    'notifications.event.stale_unpaid': 'Cobros pendientes',
    'notifications.event.class_cancelled': 'Clase cancelada',
    'notifications.event.new_signup': 'Nuevo registro',
    'notifications.event.test': 'Prueba',
    'notifications.event.unknown': 'Desconocido',
    'notifications.status.sent': 'Enviado',
    'notifications.status.failed': 'Error',
    'notifications.status.opted_out': 'No opt-in',
    'notifications.status.not_configured': 'Sin config',
    ...
    'landing.schedule.empty': 'Próximamente publicaremos los horarios.',
  ...
  en: {
    ...
    'auth.step1Email': 'Log in with your email and password.',
    'auth.step2Confirm': 'Request a pass to get started.',
    'auth.step3Login': "You'll receive a confirmation on WhatsApp when your pass is approved, and then you can start booking classes.",
    ...
    'admin.generateSub': 'Manual schedule adjustments',
    ...
    'admin.generateAutoInfo': 'Classes are auto-generated every day at 7am. Use the buttons below only if you want to apply changes right now, without waiting for the next automatic run.',
    'admin.generatePreviewTitle': 'Preview what would happen',
    'admin.generatePreviewDesc': 'Shows how many classes would be created, cancelled, or restored with the current settings. No real changes are made.',
    'admin.generateNextTitle': 'Generate classes now',
    'admin.generateNextDesc': 'Creates missing classes for the next 2 weeks based on active templates. Existing classes are not changed.',
    'admin.resyncTitle': 'Update already-created classes',
    'admin.resyncDesc': 'If you edited the time, type, or capacity of a template, this button updates future classes that were already created to reflect the changes.',
    ...
    'notifications.loadError': 'Error loading history.',
    'notifications.allChannels': 'All channels',
    'notifications.allEvents': 'All events',
    'notifications.noResults': 'No results',
    'notifications.countRange': '{from}–{to} of {total}',
    'notifications.noRecords': 'No records',
    'notifications.prev': '← Previous',
    'notifications.next': 'Next →',
    'notifications.message': 'Message',
    'notifications.fullError': 'Full error',
    'notifications.exactDate': 'Exact date',
    'notifications.details': 'Details',
    'notifications.timeNow': 'now',
    'notifications.timeMinutes': '{n} min ago',
    'notifications.timeHours': '{n} h ago',
    'notifications.timeYesterday': 'yesterday',
    'notifications.timeDays': '{n} d ago',
    'notifications.event.pass_request': 'Pass request',
    'notifications.event.pass_approved': 'Pass approved',
    'notifications.event.pass_declined': 'Pass declined',
    'notifications.event.expiry_reminder': 'Expiry reminder',
    'notifications.event.low_classes': 'Low classes',
    'notifications.event.stale_unpaid': 'Pending payments',
    'notifications.event.class_cancelled': 'Class cancelled',
    'notifications.event.new_signup': 'New signup',
    'notifications.event.test': 'Test',
    'notifications.event.unknown': 'Unknown',
    'notifications.status.sent': 'Sent',
    'notifications.status.failed': 'Error',
    'notifications.status.opted_out': 'No opt-in',
    'notifications.status.not_configured': 'Not configured',
    ...
    'landing.schedule.empty': 'Schedule coming soon.',
